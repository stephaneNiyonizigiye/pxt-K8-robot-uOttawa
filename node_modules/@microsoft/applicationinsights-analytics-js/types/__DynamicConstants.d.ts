...
export declare const _DYN_DISABLE_EXCEPTION_TR0 = "disableExceptionTracking";
export declare const _DYN_AUTO_TRACK_PAGE_VISI1 = "autoTrackPageVisitTime";
...
export declare const _DYN_TRACK_PREVIOUS_PAGE_9 = "trackPreviousPageVisit";
export declare const _DYN_SEND_PAGE_VIEW_INTER10 = "sendPageViewInternal";
export declare const _DYN_SEND_PAGE_VIEW_PERFO11 = "sendPageViewPerformanceInternal";
export declare const _DYN_POPULATE_PAGE_VIEW_P12 = "populatePageViewPerformanceEvent";
export declare const _DYN_HREF = "href";
export declare const _DYN_SEND_EXCEPTION_INTER13 = "sendExceptionInternal";
...
export declare const _DYN__CREATE_AUTO_EXCEPTI14 = "CreateAutoException";
export declare const _DYN_ADD_TELEMETRY_INITIA15 = "addTelemetryInitializer";
export declare const _DYN_DURATION = "duration";
export declare const _DYN_LENGTH = "length";
export declare const _DYN_IS_PERFORMANCE_TIMIN16 = "isPerformanceTimingSupported";
export declare const _DYN_GET_PERFORMANCE_TIMI17 = "getPerformanceTiming";
export declare const _DYN_NAVIGATION_START = "navigationStart";
export declare const _DYN_SHOULD_COLLECT_DURAT18 = "shouldCollectDuration";
export declare const _DYN_IS_PERFORMANCE_TIMIN19 = "isPerformanceTimingDataReady";
...
export declare const _DYN_PAGE_VISIT_START_TIM20 = "pageVisitStartTime";
